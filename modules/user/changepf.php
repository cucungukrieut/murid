...
<br/>
  ...
  <fieldset>
            <h2><legend style="color:darkred;">Update User's Profile Picture</legend></h2>
...
if(isset($_POST['uploadf'])){
	...
	mysql_query("UPDATE `useraccounts` SET `imagename`='$name',`imagefile`='$image' where userID = '$_SESSION[userID]'");
