    ...
    $.fn.aToolTip = function(options) {
		...
		return this.each(function() {
			...
			if(obj.attr('title')){
				...
				var tipContent = "<span class='glyphicon glyphicon-hand-left'></span> " + obj.attr('title');	 
			} else {
			...
			if(tipContent && !settings.clickIt){	
				...
				obj.hover(function(el){
					...
					.stop().show("shrink", settings.inSpeed);	
			    },
				function(){ 
					// Fade out
		    ...
		    if(tipContent && settings.clickIt){
				...
				obj.click(function(el){
					obj.attr({title: ''});						  
					$('body').append("<div class='"+ settings.toolTipClass +"'><p class='aToolTipContent'><span class='glyphicon glyphicon-'"+ tipContent +"</p></div>");
