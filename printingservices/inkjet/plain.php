...
$nid = $ressx['nid'];
 ...
 date_default_timezone_set('Asia/Manila');  
 $dates = date("Y-m-d");
 mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'Plain', 'Inkjet', ' $dates')");
