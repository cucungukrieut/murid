...
<form action="index.php?view=attendance" class="form-horizontal well span9" method="post">
    <fieldset>
      <h3 style="color:white; background:darkred; height:25px; border-radius:0px 50px 50px 0px; box-shadow:1px 1px 1px 1px #777;" >Colored Printing</h3>
...
/*********************************Short papersize****************************/
   ...
   $deducted = ((6 + 6) * $pages); //multiply to default minutes cost per page
...
$nid = $ressx['nid'];
 ...
 date_default_timezone_set('Asia/Manila');  
 $dates = date("Y-m-d");
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'Colored', 'Inkjet',' $dates')");
  ...
  echo '<meta http-equiv="Refresh" content="0">';
    ...
    }elseif($csize == 'onefourth' OR $csize == 'onehalf'){
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'Colored', 'Inkjet',' $dates')");
   ...
   $deducted = ((18 + 6)* $pages); //multiply to default minutes cost per page
...
/*********************************Long papersize****************************/
    ...
    if($csize == 'oneeight'){
       ...
       $deducted = ((12 + 12) * $pages); //multiply to default minutes cost per page
