...
<form action="index.php?view=attendance" class="form-horizontal well span9" method="post">
    <fieldset>
      <h3 style="color:white; background:darkred; height:25px; border-radius:0px 50px 50px 0px; box-shadow:1px 1px 1px 1px #777;" >With Picture Printing</h3>
...
<div class="col-md-2">
 ...
 <br/>
        ...
        <button style="background:#0a0;color:white; border-radius: 50px 50px; box-shadow:1px 2px 2px 1px #777;" type="submit"  title='Save to record' name="colored" class="btn btn-default"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
...
$nid = $ressx['nid'];
 ...
 mysql_query("UPDATE balances SET balanceaccount = '$timeleft' WHERE studID = '$id' AND balanceID = '$nid' AND schoolyear = '$sy' AND semester = '$sem' ");
   ...
   date_default_timezone_set('Asia/Manila');  
 $dates = date("Y-m-d");
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
   ...
   $deducted = ((12 + 36)* $pages); //multiply to default minutes cost per page
...
/*********************************Long papersize****************************/
    ...
    if($csize == 'oneeight'){
       ...
       $deducted = ((18 + 24) * $pages); //multiply to default minutes cost per page
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
   ...
   echo '<meta http-equiv="Refresh" content="0">';
    ?>
      ...
      $deducted= ((18 + 30) * $pages); //multiply to default minutes cost per page
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
    ...
    ?>
      ...
      $deducted= ((18 + 36) * $pages); //multiply to default minutes cost per page
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
    ...
    ?>
      <script type="text/javascript">
       ...
       $deducted = ((18 + 54) * $pages); //multiply to default minutes cost per page
...
mysql_query("INSERT INTO `printingreports` (`repID`, `datetimeissued`, `userID`, `studID`, `NoOfPage`,`TimeCost`, `PaperSize`,`printingtype`, `printertype`, `daily`) VALUES ('', '$datetime', '$_SESSION[userID]', '$id', '$pages','$timecost', '$psize', 'With pic', 'Laser',' $dates')");
    ...
    ?>
      <script type="text/javascript">
       ...
       $deducted = ((18 + 66) * $pages); //multiply to default minutes cost per page
