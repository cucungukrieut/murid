...
$res = mysql_fetch_array($sql);
      ...
      echo'  <a  id="print_btn"  style="background:#800020;color:white; border-radius:50px 50px; box-shadow:1px 2px 2px 1px #777;" href="../../index.php" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> BACK</a>
       <h2 style="color:darkred;  ">PRINTING SERVICES FOR LASER PRINTER <span style="color:blue;">( '.$res['schoolyear'].' '.$res['semester'].' )</span></h2>';
...
<center>
         ...
         <a  id="print_btn"  style="background:#0a0;color:white; border-radius:50px 50px; box-shadow:1px 2px 2px 1px #777;" href="?withpics" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> WITH PICTURE</a>
     </center>
