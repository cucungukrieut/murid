...
$res = mysql_fetch_array($sql);
      ...
      echo'<h2 style="color:darkred;  ">PRINTING SERVICES <span style="color:blue;">( '.$res['schoolyear'].' '.$res['semester'].' )</span></h2>';
...
<center>
         ...
         <a  id="print_btn"  style="background:#0a0;color:white; border-radius:50px 50px; box-shadow:1px 2px 2px 1px #777;" href="printingservices/inkjet" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> INKJET PRINTER</a>
         <a  id="print_btn"  style="background:#0a0;color:white; border-radius:50px 50px; box-shadow:1px 2px 2px 1px #777;" href="printingservices/laser" class="btn btn-default"><span class="glyphicon glyphicon-print"></span> LASER PRINTER</a>
       </center>
